...
;
;
function Aurora(param) {
    let { children, colorStops = [
        "#3971F9",
        "#D974FB",
        "#F84F07"
    ], blend = 0.5, amplitude = 0.8, speed = 0.3 } = param;
    _s();
    ...
    const colors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Aurora.useMemo[colors]": ()=>{
            const hexToRgb = {
                "Aurora.useMemo[colors].hexToRgb": (hex)=>{
            ...
            }["Aurora.useMemo[colors].hexToRgb"];
    ...
    const shaderSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Aurora.useMemo[shaderSource]": ()=>{
            const vertex = "\n      attribute vec2 position;\n      void main() {\n        gl_Position = vec4(position, 0, 1);\n      }\n    ";
            const fragment = "\n      precision highp float;\n      uniform float uTime;\n      uniform vec2 uResolution;\n      uniform float uBlend;\n      uniform float uAmplitude;\n      uniform float uSpeed;\n      \n      // Noise function for smoother aurora effect\n      float noise(vec2 p) {\n        return fract(sin(dot(p, vec2(12.9898, 78.233))) * 43758.5453);\n      }\n      \n      float smoothNoise(vec2 p) {\n        vec2 i = floor(p);\n        vec2 f = fract(p);\n        f = f * f * (3.0 - 2.0 * f);\n        \n        float a = noise(i);\n        float b = noise(i + vec2(1.0, 0.0));\n        float c = noise(i + vec2(0.0, 1.0));\n        float d = noise(i + vec2(1.0, 1.0));\n        \n        return mix(mix(a, b, f.x), mix(c, d, f.x), f.y);\n      }\n      \n      float fractalNoise(vec2 p) {\n        float value = 0.0;\n        float amplitude = uAmplitude;\n        float frequency = 1.0;\n        \n        for(int i = 0; i < 4; i++) {\n          value += amplitude * smoothNoise(p * frequency);\n          amplitude *= 0.5;\n          frequency *= 2.0;\n        }\n        \n        return value;\n      }\n      \n      void main() {\n        vec2 uv = gl_FragCoord.xy / uResolution.xy;\n        vec2 p = (uv - 0.5) * 2.0;\n        \n        float time = uTime * uSpeed;\n        \n        // Create flowing aurora effect\n        vec2 flow = vec2(\n          fractalNoise(p * 2.0 + vec2(time * 0.5, time * 0.3)),\n          fractalNoise(p * 2.0 + vec2(time * 0.7, time * 0.5))\n        );\n        \n        float aurora = fractalNoise(p * 3.0 + flow * 0.5 + vec2(time * 0.2, time * 0.4));\n        \n        // Create gradient based on position and aurora\n        float gradient = smoothstep(-1.0, 1.0, p.x + aurora * 0.3);\n        float height = smoothstep(-1.0, 0.5, p.y + aurora * 0.2);\n        \n        // Blend colors smoothly\n        vec3 color1 = vec3(".concat(colors[0].r, ", ").concat(colors[0].g, ", ").concat(colors[0].b, ");\n        vec3 color2 = vec3(").concat(colors[1].r, ", ").concat(colors[1].g, ", ").concat(colors[1].b, ");\n        vec3 color3 = vec3(").concat(colors[2].r, ", ").concat(colors[2].g, ", ").concat(colors[2].b, ");\n        \n        vec3 color = mix(color1, color2, gradient);\n        color = mix(color, color3, height);\n        \n        // Add aurora variation\n        color += aurora * 0.1 * (color2 - color1);\n        \n        // Soft edges and transparency\n        float edge = smoothstep(1.5, 0.5, length(p));\n        float alpha = edge * uBlend * (0.2 + aurora * 0.3);\n        \n        gl_FragColor = vec4(color, alpha);\n      }\n    ");
            return {
                vertex,
                fragment
            };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Aurora.useEffect": ()=>{
            ...
            const program = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ogl$2f$src$2f$core$2f$Program$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Program"](gl, shaderSource);
            ...
            program.uniforms.uResolution = {
                value: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ogl$2f$src$2f$math$2f$Vec2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec2"](canvas.width, canvas.height)
            };
            program.uniforms.uBlend = {
                value: blend
            };
            program.uniforms.uAmplitude = {
                value: amplitude
            };
            program.uniforms.uSpeed = {
                value: speed
            };
            // Animation loop
            let animationId;
...
_s(Aurora, "kINBW7N25CWYCJ3KcPyPVPmzV/E=");
_c = Aurora;
var _c;
...
function HeroSection() {
    ...
    const scrollToContact = ()=>{
        // Placeholder scroll - will be updated when contact section is built
        window.scrollTo({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "relative h-[95vh] flex items-center justify-center px-4 sm:px-6 lg:px-8",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].h1, {
                            ...
                            className: "text-5xl sm:text-7xl lg:text-9xl font-instrument-serif font-normal tracking-tight",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].p, {
                            variants: textVariants,
                            className: "text-xl sm:text-2xl lg:text-3xl font-archivo font-medium tracking-wide text-gray-300",
                            children: "audio. web. ux/ui."
                        }, void 0, false, {
                            fileName: "[project]/src/components/HeroSection.tsx",
                            lineNumber: 63,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].p, {
                            variants: textVariants,
                            className: "text-base sm:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed font-archivo font-normal",
                            children: "Empowering small businesses, NDIS providers, and creative entrepreneurs with professional audio, web development, and UX/UI design services."
                        }, void 0, false, {
                            fileName: "[project]/src/components/HeroSection.tsx",
                            lineNumber: 71,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                ...
                                className: "bg-yellow text-dark px-8 py-4 rounded-2xl font-archivo font-semibold text-lg hover:bg-yellow/90 transition-all duration-200 shadow-lg hover:shadow-xl",
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            className: "text-xl font-instrument-serif text-white",
                            children: "Duke St. Studio"
                        }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                href: "#about",
                                className: "text-gray-300 hover:text-white transition-colors duration-200 font-archivo font-medium",
                                children: "About"
                            }, void 0, false, {
                                fileName: "[project]/src/components/Navigation.tsx",
                                lineNumber: 27,
...
"[project]/src/components/AuroraTester.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>AuroraTester
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
...
"use client";
;
function AuroraTester(param) {
    let { onSettingsChange } = param;
    _s();
    const [blend, setBlend] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.4);
    const [amplitude, setAmplitude] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.6);
    const [speed, setSpeed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.2);
    const handleBlendChange = (value)=>{
        setBlend(value);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed top-20 right-4 z-50 bg-dark/90 backdrop-blur-sm p-4 rounded-xl border border-white/20 text-white",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                className: "text-sm font-archivo font-semibold mb-3",
                children: "Aurora Controls"
            }, void 0, false, {
                fileName: "[project]/src/components/AuroraTester.tsx",
                lineNumber: 31,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AuroraTester, "RtQbbNJd4qEpCbS/d9okkByvw/c=");
_c = AuroraTester;
var _c;
__turbopack_context__.k.register(_c, "AuroraTester");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_components_a459d73c._.js.map