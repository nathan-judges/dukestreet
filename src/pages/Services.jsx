...
const Services = () => {
  ...
  return (
    <>
      <SEO 
        title="Services"
        description="Discover our comprehensive range of digital services including web development, podcast production, and brand design. Tailored solutions for your business needs."
      />
